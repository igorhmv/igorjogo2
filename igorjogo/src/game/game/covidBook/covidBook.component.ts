...
export class CovidBookComponent extends Phaser.Scene implements OnInit {
  ...
  create(){
    ...
    this.add.text(width/2-400,80,'Confira abaixo pequenos detalhes sobre as variantes do COVID-19:', { font: '20px Arial',color:'#000000' });
    ...
    this.add.text(width/4-100,150,infoAlpha.toString(),{ font: '20px Arial',color:'#000000' });
    ...
    this.add.text(width/4-100,250,infoBeta.toString(),{ font: '20px Arial',color:'#000000' });
    ...
    this.add.text(width/4-100,350,infoGamma.toString(),{ font: '20px Arial',color:'#000000' });
    ...
    this.add.text(width/4-100,450,infoDelta.toString(),{ font: '20px Arial',color:'#000000' });
